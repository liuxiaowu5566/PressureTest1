...
namespace Models.Model.t4
{
    ...
    public partial class T4_House_Show : BaseModel
    {
        public T4_House_Show()
        {
        ...
        /// </summary>           
        [Head("column10", "-")]
        public List<t4_tel> column10 { get; set; }
    ...
    public partial class T4_House_Part : BaseModel
    {
        public T4_House_Part()
        {
