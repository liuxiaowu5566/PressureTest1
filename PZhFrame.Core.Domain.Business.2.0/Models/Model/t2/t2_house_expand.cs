...
{
    public partial class t2_house_expand : BaseModel
    {
            public t2_house_expand()
            {
            ...
            /// </summary>           
            [Head("column4", "-")]
            public List<T2_ModifyLogModel> column4 { get; set; }
            ...
            /// </summary>           
            [Head("column5", "-")]
            public List<T2_ModifyLogModel> column5 { get; set; }
            ...
            /// </summary>           
            [Head("column6", "-")]
            public List<T2_ModifyLogModel> column6 { get; set; }
            ...
            /// </summary>           
            [Head("column7", "-")]
            public List<T2_ModifyLogModel> column7 { get; set; }
            ...
            /// </summary>           
            [Head("column8", "-")]
            public List<T2_ModifyLogModel> column8 { get; set; }
            ...
            /// </summary>           
            [Head("column10", "-")]
            public List<T2_ModifyJsonModel> column10 { get; set; }
